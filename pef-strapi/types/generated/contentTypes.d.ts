...
export interface ApiExtensaoExtensao extends Struct.SingleTypeSchema {
  collectionName: 'extensoes';
  info: {
    displayName: 'Extensao';
    pluralName: 'extensoes';
    singularName: 'extensao';
  };
  options: {
...
export interface ApiIcIc extends Struct.SingleTypeSchema {
  collectionName: 'ics';
  info: {
    displayName: 'IC';
    pluralName: 'ics';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::ic.ic'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    titulo: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiLaboratorioLaboratorio extends Struct.SingleTypeSchema {
...
export interface ApiPesquisaPesquisa extends Struct.SingleTypeSchema {
  ...
  info: {
    ...
    pluralName: 'pesquisas';
    singularName: 'pesquisa';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiPosdocPosdoc extends Struct.SingleTypeSchema {
  collectionName: 'posdocs';
  info: {
    displayName: 'Posdoc';
    pluralName: 'posdocs';
    singularName: 'posdoc';
...
export interface ApiProfessorProfessor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    foto: Schema.Attribute.Media<
      ...
      true
    >;
    lattes: Schema.Attribute.String;
...
export interface ApiTeseTese extends Struct.SingleTypeSchema {
  collectionName: 'teses';
  info: {
    displayName: 'Teses';
    pluralName: 'teses';
    singularName: 'tese';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::tese.tese'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    titulo: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
